...
using ResturantServices.Identity.MainModule.Account;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            //reove testuser and use the user, signin and role manager dependency injection
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                ////user defined code to use normal users and not the test users
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await userManger.AddClaimsAsync(user, new Claim[]{
                    ...
                    {
                        var checkuser = await userManger.FindByNameAsync(model.Username);
